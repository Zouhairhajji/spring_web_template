                    ...
                    <form:form class="form-horizontal"  modelAttribute="role">
                        <div class="box-body">
                            ...
                            <spring:bind path="viewComponents">
                                <div class="form-group ${status.error ? 'has-error' : ''}">
                                    <label class="col-sm-2 control-label">View Components :</label>
                                    <div class="col-sm-5">
                            ...
                            <spring:bind path="useCases">
                                <div class="form-group ${status.error ? 'has-error' : ''}">
                                    <label class="col-sm-2 control-label"><spring:message code="as.uc" /> :</label>
                                    <div class="col-sm-5">
                                        <form:select path="useCases" items="${useCases}" itemLabel="useCase" itemValue="idUseCase"
                                                     multiple="true" size="5" class="form-control" />
                                        <form:errors path="useCases" class="control-label" />
                                    </div>
                                    <div class="col-sm-5"></div>
                                </div>
                            </spring:bind>
                        ...
                        <div class="box-footer">
                            <div class="col-lg-6">
                                <button type="submit" class="btn btn-block btn-primary btn-flat">Modifier</button>
                            </div>
                            <div class="col-lg-6">
                                <a href="<c:url value="/roles/list" />" class="btn btn-block btn-primary btn-flat">Retourner</a>
                            </div>
                        </div>
                    </form:form>
                </section>
